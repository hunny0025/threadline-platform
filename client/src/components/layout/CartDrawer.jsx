      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            transition={{
              type: "tween",
              ease: [0.43, 0.13, 0.23, 0.96], // Cubic Bezier per requirements
              duration: 0.4,
            }}
          >
            {/* Header */}
                      ...
                      <div className="flex flex-1 flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between mt-4">
                          ...
                          <button
                            ...
                            className="text-sm font-medium text-zinc-400 hover:text-red-500 transition-colors flex items-center gap-1.5"
                          >
